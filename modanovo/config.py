...
class Config:
    ...
    _config_types = dict(
        ...
        devices=int,
        lance_dir_name=str, 
        save_correct_seq=bool,
        train_from_default_residues=bool,
        ...
        shuffle=bool,
        buffer_size=int,
        discarded_residue_predictions=list
        ...
        try:
            ...
            if param == "expanded_residues":
                if param_val is not None:
                    ...
                    expanded_residues = {}
                self._params["expanded_residues"] = expanded_residues
            elif param =='discarded_residue_predictions':
                if param_val is None:
                    self._params["discarded_residue_predictions"] = []
                else:
                    self._params["discarded_residue_predictions"] = list(param_val)
