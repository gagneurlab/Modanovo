...
class MztabWriter:
    ...
    def set_metadata(self, config: Config, **kwargs) -> None:
        ...
        for aa, mass in config["expanded_residues"].items():
               ...
               #     true_seq
                writer.writerow(
                    [
                        ...
                        psm[7],#f"ms_run[{self._run_map[filename]}]:{idx}",
                        "null",  # pre
                        "null",  # post
                        "null",  # start
                        "null",  # end
                        psm[8],  # opt_correct_seq
                        psm[6],  # opt_ms_run[1]_aa_scores
                        psm[9],  # title
                        i, #psm[10]  # idx for softmax mapping
                    ]
                )
